# typescript-pdf-viewer-examples
This repository contains examples of Syncfusion&reg; PDF Viewer (Web) control.

## Key features
The TypeScript PDF Viewer component allows to view, print, and annotate the PDF files in your TypeScript applications and its key features are,
...
* [Annotations](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/javascript-es6/annotations/overview/) - Annotate with text markup, shapes, stamps, ink, and sticky notes.
* [Form Fields](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/javascript-es6/forms/overview/) - Form filling and form designing can be done.
...
* [Search](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/javascript-es6/text-search/text-search-features/) - Search a text easily across the PDF document.	
...
* [Print](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/javascript-es6/print/overview/) - Print the entire document or a specific page directly from the browser.
* [Download](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/javascript-es6/download/) - Download the complete document currently loaded in the PDF Viewer.
* [Text Selection](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/javascript-es6/textselection/) - Select and copy text from a PDF file.
...
* <a href="Text Search and Extraction">Text Search and Extraction</a>
